        ...
        for (DatiDaImportareAppartenente datiDaImportareAppartenente : appartenentiDaImportare) {
            ...
            if (posizione != null) {
                ...
                if (azione.equals(Operation.Azione.EDIT)) {
                    ...
                    if (idCaselleReplicateMap.containsKey(datiDaImportareAppartenente.getIdCasella()) || isCoinvoltoInReplica(struttura, mappaReplichePerIdCasellaSorgente, mappaReplichePerIdCasellaDestinazione, queryFactory) != null) {
...
//             se posizione è null allora non ho una riga tra le importate che mi rappresenta l'appartenente'
        ...
        for (DatiImportatiAppartenente appartenenteImportato : appartenentiImportati) {
            if (indexDaImportare != null && !indexDaImportare.isEmpty() && !indexDaImportare.containsKey(appartenenteImportato.getKey())) {
                ...
                if (idCaselleReplicateMap.containsKey(appartenenteImportato.getIdCasella()) || isCoinvoltoInReplica(struttura, mappaReplichePerIdCasellaSorgente, mappaReplichePerIdCasellaDestinazione, queryFactory) != null) {
