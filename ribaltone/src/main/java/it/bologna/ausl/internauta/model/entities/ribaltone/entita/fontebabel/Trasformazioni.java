 ...
 */
@Entity
@Table(name = "trasformazioni", catalog = "internauta", schema = "ribaltone")
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
@GenerateProjections({})
@DynamicUpdate
public class Trasformazioni implements Serializable {
    ...
    public Trasformazioni(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Trasformazioni)) {
            return false;
        }
        Trasformazioni other = (Trasformazioni) object;
