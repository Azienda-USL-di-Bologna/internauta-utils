 ...
 * @author Top
 */
public class OperationAnagrafiche extends Operation<DatiDaImportareAnagrafica> {

    public OperationAnagrafiche(Azione azione, DatiDaImportareAnagrafica entitaCoinvolta) {
