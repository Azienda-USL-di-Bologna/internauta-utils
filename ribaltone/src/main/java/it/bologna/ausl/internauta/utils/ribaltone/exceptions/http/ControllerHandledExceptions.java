...
public interface ControllerHandledExceptions {
    ...
    public default Map<String, Object> handleConflitctException(RibaltoneHttpException ex) {
    ...
    public default Map<String, Object> handleBadGatewayException(RibaltoneHttpException ex) {
