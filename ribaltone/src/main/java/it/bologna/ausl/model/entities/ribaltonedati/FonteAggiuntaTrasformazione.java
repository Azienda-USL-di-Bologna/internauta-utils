...
public class FonteAggiuntaTrasformazione implements Serializable {
    ...
    public String toString() {
        return "it.bologna.ausl.internauta.model.entities.FonteBabelTrasformazione[progressivo_riga=" + progressivoRiga + ", id_casella_partenza=" + idCasellaPartenza + ", id_casella_arrivo=" + idCasellaArrivo + ", codice_ente=" + codiceEnte + ", codiceAzienda=" + codiceAzienda + ", id=" + id + " ]";
    }
