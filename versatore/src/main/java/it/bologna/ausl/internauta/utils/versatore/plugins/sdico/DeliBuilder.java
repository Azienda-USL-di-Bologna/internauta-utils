...
public class DeliBuilder {
    ...
    public DeliBuilder(DocDetail docDetail, Archivio archivioScelto) {
        versamentoBuilder = new VersamentoBuilder();
        this.docDetail = docDetail;
        this.archivio = archivioScelto;
    }
    ...
    public VersamentoBuilder build() {
        ...
        if (archivio.getAnniTenuta() != null && archivio.getAnniTenuta() != 999) anniTenuta = archivio.getAnniTenuta().toString();
