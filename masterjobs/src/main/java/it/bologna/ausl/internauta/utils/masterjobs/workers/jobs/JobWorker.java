...
public abstract class JobWorker<T extends JobWorkerData, R extends JobWorkerResult> extends Worker {
    ...
    public UUID calcolaMD5(ZonedDateTime executionTs) throws JsonProcessingException, NoSuchAlgorithmException{
        ...
        String md5 = getMD5(this, executionTs);
     ...
     */
    private String getMD5(JobWorker worker, ZonedDateTime executionTs) throws NoSuchAlgorithmException, JsonProcessingException {
