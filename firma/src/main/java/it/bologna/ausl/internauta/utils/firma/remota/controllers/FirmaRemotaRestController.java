...
//        return res;
    ...
    /**
    Restituisce l'elenco delle firme delega
    @return
     */
    @RequestMapping(value = "/firmeDelega", method = RequestMethod.GET)
    public List<FirmaDelega> getFirmeDelega() {
        return firmaDelegaRepository.findAll();
    }
}
